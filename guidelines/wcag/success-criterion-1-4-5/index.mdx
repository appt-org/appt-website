...
description: Ensure images are not used to display text. Text in an image often scales to a limited extent or not at all. Use plain text to allow the text to scale based on the user's preferences.
authors: [janjaap]
hide_title: true
date: 2022-06-16
last_update:
