...
description: Ensure that audio which lasts longer than three seconds can be paused or stopped. This is important for people who have difficulty concentrating. In addition, the screen reader is difficult to use when other audio is playing.
authors: [janjaap]
hide_title: true
date: 2022-06-16
last_update:
