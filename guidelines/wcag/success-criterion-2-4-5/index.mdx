...
title: Success Criterion 2.4.5 - Multiple Ways - Level AA
description: Ensure users can reach the screens of an app in multiple ways. For example, onboarding screens are often shown when an app is first launched. You should offer these screens elsewhere in the app so they can be viewed again. A search function can also be useful to jump to a certain screen.
authors: [janjaap]
hide_title: true
date: 2022-06-16
last_update:
