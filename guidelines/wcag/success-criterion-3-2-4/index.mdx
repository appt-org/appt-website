...
title: Success Criterion 3.2.4 - Consistent Identification - Level AA
description: Ensure icons always have the same function. For example, only use a magnifying glass icon to search, and not to enlarge. This makes it clear to users which function they can expect from this icon.
authors: [janjaap]
hide_title: true
date: 2022-06-16
last_update:
