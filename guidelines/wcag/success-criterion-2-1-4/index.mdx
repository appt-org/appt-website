...
description: Ensure that shortcuts cannot be accidentally activated when using assistive technologies. Many assistive technologies emulate keystrokes to perform actions. Users might accidentally activate shortcuts. Make it possible to change or disable shortcuts.
authors: [janjaap]
hide_title: true
date: 2022-06-16
last_update:
