...
<LinkList title="List of screen reader features" isHighlighted={true}>
  <LinkListItem url="https://appt.org/en/docs/android/features/talkback" title="TalkBack for Android" pageTitle="TalkBack: screen reader for Android" shortDescription="This article provides in-depth information about the TalkBack screen reader for Android." icon="/img/light/screenreader.svg" iconAlt="Screen Reader icon"/>
  <LinkListItem url="https://appt.org/en/docs/ios/features/voiceover" title="VoiceOver for iOS" pageTitle="VoiceOver: screen reader for iOS" shortDescription="This article provides in-depth information about the VoiceOver screen reader on iOS." icon="/img/light/screenreader.svg" iconAlt="Screen Reader icon"/>
</LinkList>
