...
# Accessibility label (multi-platform)
...
<TabItem value="swift-ui" label="SwiftUI">

With SwiftUI, you can use the accessibilityLabel() method to set an accessibility label.
...
<TabItem value="xamarin" label="Xamarin">
