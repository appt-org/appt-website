---
locale: en
slug: /xamarin/samples/redundant-entry
title: Redundant entry on Xamarin
...
<CodeSample id="redundant-entry" platform="xamarin" locale="en"/>
