---
locale: en
slug: /net-maui/samples/reduced-animations
platformFilter: Xamarin
title: Reduced animations in .NET MAUI
...
# Reduced animations in .NET MAUI
...
<CodeSample id="screen-animations" locale="en" platform="net-maui"/>
