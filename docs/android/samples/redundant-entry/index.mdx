---
locale: en
slug: /android/samples/redundant-entry
title: Redundant entry on Android
...
<CodeSample id="redundant-entry" platform="android" locale="en"/>
