...
2. View the item you want to select. Check the color marker used for the group the item is in.
3. Press the switch that corresponds to the color of the group.
4. Repeat steps 2 and 3 until you can select the item. The color markings change every time you press a switch.
