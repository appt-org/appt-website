---
locale: en
slug: /swiftui/samples/input-keyboard-type
contentful_id: 3s5M6LNhOwnr1peUToZBfe
title: Input keyboard type in SwiftUI
...
# Input keyboard type in SwiftUI
...
<CodeSample id="input-keyboard-type" platform="swiftui" locale="en"/>
