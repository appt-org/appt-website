---
locale: en
slug: /swiftui/samples/adjustable-timing
contentful_id: 49oEZYxsxUnSsJiG7BSHrq
title: Adjustable timing in SwiftUI
...
<CodeSample id="screen-timing" platform="swiftui" locale="en"/>
