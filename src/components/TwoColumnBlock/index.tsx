...
export function TwoColumnBlock({
  ...
  const rowClasses = clsx('mx-auto px-4 sm:px-8 max-w-md grid gap-4 grid-cols-1', {
  ...
  const imageClasses = clsx(
    ...
    {
      '[&>div>img]:lg:h-auto [&>div>img]:lg:min-h-[360px]': !hasLargerBreakpoint,
      '[&>div>img]:2xl:h-auto [&>div>img]:2xl:min-h-[360px]': hasLargerBreakpoint,
    },
  );
