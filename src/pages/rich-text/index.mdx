...
[Internal link](https://appt.org/en/)

[External link](https://appt.nl/)

<CustomLink url="https://appt.org/en/" label="Primary button" appearance="primary button" />

<CustomLink url="https://appt.org/en/" label="Secondary button" appearance="secondary button" />

<CustomLink url="https://appt.nl/" label="Primary button extern" appearance="primary button" />

<CustomLink url="https://appt.nl/" label="Secondary button extern" appearance="secondary button" />

Een [internal link](https://appt.org/en/rich-text) in een tekst en een [external link](https://firebase.google.com/) in een tekst.

Een [`internal code link`](https://appt.org/en/rich-text) in een tekst en een [`external code link`](https://firebase.google.com/) in een tekst.
...
<LinkList title="Regular link list" isHighlighted={false}>
  <LinkListItem url="https://appt.org/en/" title="Mara Polak"/>
  <LinkListItem url="https://appt.org/en/" title="Johan Huijkman"/>
...
<PercentageBlock
  ...
  linkLabel="Rich text"
  linkUrl="https://appt.org/en/rich-text">
...
<PercentageBlock
  ...
  linkLabel="Docs"
  linkUrl="https://appt.org/en/docs">
