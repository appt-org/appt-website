...
contentfulID: H5vzMG1Fh1Jzpk6nY3D6b
type: pageContentPage
title: Zo laat je een toegankelijke app ontwikkelen
shortDescription: Dit artikel, gericht op niet-developers, legt uit waar je moet beginnen als je een app toegankelijk wilt laten maken.
thumbnail: Development - Icon
seo.title: Zo laat je een toegankelijke app ontwikkelen
seo.name: Accessible App - Guide for non-developers - SEO
seo.description: In dit artikel geven we je tips waar je moet beginnen en waar je rekening mee moet houden als je een app toegankelijk wilt maken voor een zo groot mogelijke groep gebruikers, waaronder mensen met een beperking.
hero.title: Zo laat je een toegankelijke app ontwikkelen
hero.introText: In dit artikel geven we je tips waar je moet beginnen en waar je rekening mee moet houden als je een app toegankelijk wilt maken voor een zo groot mogelijke groep gebruikers, waaronder mensen met een beperking. 
hero.useThumbnail: false
---

<Hero
  title="Zo laat je een toegankelijke app ontwikkelen"
  introText="In dit artikel geven we je tips waar je moet beginnen en waar je rekening mee moet houden als je een app toegankelijk wilt maken voor een zo groot mogelijke groep gebruikers, waaronder mensen met een beperking. "
/>
  ...
  <LeftColumn>
    <ColumnRow>
      <PercentageBlock
        ...
        linkLabel="Alle gebruiksstatistieken"
        linkUrl="/nl/stats">
...
<Quote
  ...
  alt="Foto Jesse"
  linkLabel="Bekijk alle interviews"
  url="https://appt.org/nl/articles/interviews"
/>

Naast deze functies gebruiken veel mensen met een beperking externe hulpmiddelen om toegang te krijgen tot digitale media. Ben je benieuwd welke hulpmiddelen er bestaan om apps te gebruiken? De meest gebruikte hulpmiddelen zijn de schermlezer, stembediening, schakelbediening en toetsenbordbediening. Wat dat zijn en hoe ze werken leggen we uit op [de pagina hulpmiddelen](https://appt.org/nl/articles/assistive-technologies).
...
<LinkList title="WCAG Testing for Beginners Link" isHighlighted={true}>
  <LinkListItem url="https://appt.org/nl/guidelines/beginnersguide-accessibility-testing" title="Beginnersgids toegankelijkheid testen" pageTitle="Beginnersgids toegankelijkheid testen" shortDescription="Hoe test je zelf of je app toegankelijk is?" icon="/img/light/features.svg" iconAlt="Features icon"/>
</LinkList>
...
Om je alvast een idee te geven waar je rekening mee moet houden hebben we een aantal [interviews met gebruikers](https://appt.org/nl/articles/interviews) gedaan. 
...
Of je nu helemaal opnieuw begint of een bestaande app toegankelijk wilt maken, onze [startersgids voor developers](https://appt.org/nl/articles/accessible-app-beginners-guide) helpt programmeurs op weg. Handig om te delen met je developmentteam!
...
De statistieken uit dit onderzoek worden mogen vrijelijk worden gebruikt. Zet ze dus in om een (business)case te bouwen en teamleden of management te overtuigen. Je kunt hiervoor makkelijk [deze slides](https://appt.org/nl/stats/download-stats) downloaden die elke maand worden bijgewerkt met actuele cijfers.

En wil je nóg relevantere data? Via Appt.org stellen we [gratis documentatie en open source code](https://appt.org/nl/articles/gather-your-own-accessibility-data) beschikbaar waarmee organisaties zélf hun eigen app kunnen onderzoeken.
