...
Ons team vond het ook prettig dat Contentful een GraphQL API heeft om inhoud op te halen. Met onze [Appt API](https://www.contentful.com/developers/docs/references/content-delivery-api/) kun je al onze inhoud op een gestructureerde manier ophalen.
