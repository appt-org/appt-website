...
contentfulID: 4bOXm8grN7j6BiDK1jwR8a
type: pageContentPage
title: Een toegankelijke app. Waar begin je?
shortDescription: "Je app toegankelijk maken voor iedereen: waar begin je? Dit zijn de eerste zes stappen om te nemen."
thumbnail: Oplossingen - icon
seo.title: Een toegankelijke app. Waar begin je?
seo.name: Accessible App Beginnersguide  - SEO
seo.description: "Je app toegankelijk maken voor iedereen: waar begin je? Dit zijn de eerste zes stappen om te nemen."
hero.title: Een toegankelijke app. Waar begin je?
hero.introText: "Je app toegankelijk maken voor iedereen: waar begin je? Hieronder volgen de belangrijkste stappen die je helpen om je app bruikbaar te maken voor een zo groot mogelijke groep mensen, waaronder mensen met een beperking. 
"
...
Controleer daarnaast of het goed werkt door de [schermlezer](https://appt-production-o4ale4roda-ez.a.run.apphttps://appt.org/nl/stats/schermlezer) te gebruiken.

Om te testen of tekst schalen goed wordt ondersteund stel je een groot lettertype in. Dit kun je doen op een telefoon onder de [toegankelijkheidsinstellingen](https://appt.org/nl/stats/font-size).
