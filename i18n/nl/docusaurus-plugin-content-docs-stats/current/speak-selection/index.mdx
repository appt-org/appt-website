...
Een geselecteerde tekst laten voorlezen is overigens niet hetzelfde als [VoiceOver](/en/stats/screen-reader). Uit onze resultaten komt geen significant gebruik van voice-over naar voren. Maar speak screen en speak selection hebben net als VoiceOver goede labelling nodig.
