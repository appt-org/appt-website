...
<LinkList title="List of screen reader features" isHighlighted={true}>
  <LinkListItem url="/nl/docs/android/features/talkback" title="TalkBack voor Android" pageTitle="TalkBack: schermlezer voor Android" shortDescription="Dit artikel bevat verdiepende informatie over de TalkBack schermlezer voor Android." icon="/img/light/screenreader.svg" iconAlt="Screen Reader icon"/>
  <LinkListItem url="/nl/docs/ios/features/voiceover" title="VoiceOver voor iOS" pageTitle="VoiceOver: schermlezer voor iOS" shortDescription="Dit artikel bevat verdiepende informatie over de VoiceOver schermlezer voor iOS." icon="/img/light/screenreader.svg" iconAlt="Screen Reader icon"/>
</LinkList>
