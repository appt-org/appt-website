---
locale: nl
slug: /xamarin/codevoorbeelden/accessibility-hint
contentfulID: 4W4cG85O96bPLWxqlExU2h
type: pageContentPage
title: Accessibility hint on Xamarin
...
<CodeSample id="accessibility-hint" locale="nl" platform="xamarin"/>