...
contentfulID: 4rKoFoSO71DKYUisy83QHT
type: pageContentPage
title: "Voice Control: stembediening voor iOS"
shortDescription: Dit artikel bevat verdiepende informatie over de stembediening Voice Control voor iOS.
...
<Video youTubeId="G7RMsPuKFTQ" title="Handleiding: Stembediening aanzetten op iOS" name="Voice control iOS - Video"/>
...
| Swipe left`<br>``<br>``<br>``<br>`**`<item>`** | Veegt naar links op het gegeven** onderdeel** |
...
| Swipe right`<br>``<br>``<br>``<br>`**`<number>`** | Veegt naar rechts op het onderdeel met het gegeven** nummer** |
...
| Move after** `<phrase>`** | Verplaatst de cursor achter de gekoze**n zin** |
