---
locale: nl
slug: /ios/codevoorbeelden/adjustable-timing
contentful_id: 49oEZYxsxUnSsJiG7BSHrq
title: Adjustable timing on iOS
...
<CodeSample id="screen-timing" framework="ios" locale="nl"/>
