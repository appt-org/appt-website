...
It is not recommended to use decorative or irrelevant images in an app. In addition, it is important that navigating within an app is simple and with as few actions as possible. This can be made easier by using short sentences and recognizable icons. The use of color can also help with this.
