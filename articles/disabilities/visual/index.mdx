...
In addition, there are users with color blindness, which can also make it more difficult to operate an app. By default it is possible to invert colors and set color filters. Again, unfortunately, not all apps handle these settings properly.
